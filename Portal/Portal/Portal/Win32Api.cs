            ...
            private int KeyboardHookProc(int nCode, int wParam, IntPtr lParam)
            {
                ...
                if ((nCode >= 0) && (OnKeyDownEvent != null || OnKeyUpEvent != null || OnKeyPressEvent != null))
                {
                    ...
                    if (OnKeyPressEvent != null && wParam == WmKeydown)
                    {
                        ...
                        if (
                            ToAscii(keyDataFromHook.vkCode, keyDataFromHook.scanCode, keyState, inBuffer,
                    ...
                    //松开控制键
                    if ((OnKeyDownEvent != null || OnKeyPressEvent != null) && (wParam == Win32Api.WmKeyup || wParam == Win32Api.WmSyskeyup))
                    {
